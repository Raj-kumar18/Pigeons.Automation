...
function QuantumCore() {
  ...
  return (
    <group>
      ...
      {/* Dense data particles orbiting the core */}
      <Sparkles count={250} scale={6} size={2.5} speed={0.5} color="#e0aaff" opacity={0.8} />
    </group>
  );
}
  ...
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none md:pointer-events-auto">
      <Canvas camera={{ position: [0, 0, 7], fov: 45 }}>
        ...
        {/* Environment map to make glass material extremely beautiful and realistic */}
        ...
        <Stars radius={100} depth={50} count={4000} factor={3} saturation={0.5} fade speed={1} />
