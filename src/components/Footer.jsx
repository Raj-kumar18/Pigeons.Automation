    ...
    <footer className="relative bg-[#000000] z-30 pt-10">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-4 font-body text-gray-400">
            <li><a href="https://instagram.com/pigeonsautomation" target='_blank' className="hover:text-white hover:translate-x-2 inline-block transition-all duration-300">Instagram</a></li>
            <li><a href="https://x.com/PigeonsA2mation" target='_blank' className="hover:text-white hover:translate-x-2 inline-block transition-all duration-300">Twitter/X</a></li>
            <li><a href="#" target='_blank' className="hover:text-white hover:translate-x-2 inline-block transition-all duration-300">LinkedIn</a></li>
          </ul>
        </div>
      </div>
