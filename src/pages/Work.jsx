...
const projects = [
  { id: 1, title: 'Dog Studio Clone', desc: 'Premium 3D web experience clone using Three.js to explore advanced rendering.', category: 'Websites', tags: ['Three.js', 'WebGL'], image: './src/assets/dog.png', span: 'col-span-1 md:col-span-2 row-span-1', live: 'https://dogstudiio.netlify.app/' },
  { id: 2, title: 'Your Finance Son', desc: 'Premium Finance web experience in React Js.', category: 'Websites', tags: ['React', 'Finance'], image: './src/assets/yourFinanceSon.png', span: 'col-span-1 md:col-span-1 row-span-1', live: 'https://your-finance-son.vercel.app/' },
