...
const projects = [
  ...
  { id: 4, title: 'Dog Studio Clone', desc: 'Premium 3D web experience clone using Three.js to explore advanced rendering.', category: 'Websites', tags: ['Three.js', 'WebGL'], image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80', span: 'col-span-1 md:col-span-2 row-span-1', live: 'https://dogstudiio.netlify.app/', code: 'https://github.com/Raj-kumar18/Dog-Studio-Clone' },
