  ...
  return (
    <div className="pt-32 pb-20 max-w-7xl mx-auto px-6 min-h-screen flex items-center relative overflow-hidden bg-[#05050f]">
      ...
      <div className="w-full grid md:grid-cols-2 gap-24 items-center relative z-10 mt-10">
        ...
        >
          <form className="space-y-8 bg-[#05050f]/60 backdrop-blur-2xl p-10 md:p-14 rounded-3xl border border-white/5 shadow-2xl" onSubmit={(e) => e.preventDefault()}>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative group">
                <input type="text" className={inputStyles} placeholder="Your name" required />
              </div>
              <div className="relative group">
                <input type="email" className={inputStyles} placeholder="you@company.com" required />
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative group cursor-pointer">
                <select className={`${inputStyles} appearance-none cursor-pointer`} required>
                  <option value="" disabled selected className="text-gray-500 bg-[#05050f]">Project Type...</option>
              ...
              <div className="relative group cursor-pointer">
                <select className={`${inputStyles} appearance-none cursor-pointer`} required>
                  <option value="" disabled selected className="text-gray-500 bg-[#05050f]">Budget Range...</option>
            ...
            <div className="relative group">
              <textarea rows="4" className={`${inputStyles} resize-none`} placeholder="Tell us about what you want to build..." required></textarea>
            </div>

            <div className="pt-6">
              <MagneticElement strength={30} className="w-full">
                <button className="group relative w-full overflow-hidden bg-white font-heading font-bold text-xl py-6 rounded-xl transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(168,85,247,0.4)]">
